...
.. container::
   ...
   Question:
   This is a nice cheat sheet but not really TYPO3 specific. This was
   created a while ago and in the meantime there are a lot more
   resources in general, e.g. Stack Overflow, cheat sheets. Also, the
   commands now used for maintainance of TYPO3 sites has changed towards
   deployment tools, Composer, etc. Should we keep this or remove?
...
The pathname and filename should be exactly as given in the .tar.gz
file. If you want more than one file append their names, again including
pathname, at the end of the command.
...
`A-Z index of Linux Bash commands <http://www.ss64.com/bash/>`__
================================================================
