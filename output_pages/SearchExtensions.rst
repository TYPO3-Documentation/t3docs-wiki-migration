...
| 
| List of extensions that let you search a TYPO3 website.

+--------+--------+--------+--------+--------+--------+--------+--------+
| Ext    | Depend | C      | Result | In     | File   | Facets | Links  |
| ension | encies | omment | temp   | dexing | in     |        |        |
| name   |        |        | lating |        | dexing |        |        |
+--------+--------+--------+--------+--------+--------+--------+--------+
| I      | -      | part   | Yes    | `      | Yes    | No     | `      |
| ndexed |        | of     | (      | Schedu |        |        | docume |
| Search |        | TYPO3  | `Marke | ler <h |        |        | ntatio |
|        |        | core   | r <htt | ttps:/ |        |        | n <htt |
|        |        |        | ps://d | /docs. |        |        | ps://d |
|        |        |        | ocs.ty | typo3. |        |        | ocs.ty |
|        |        |        | po3.or | org/ty |        |        | po3.or |
|        |        |        | g/typo | po3cms |        |        | g/typo |
|        |        |        | 3cms/e | /exten |        |        | 3cms/e |
|        |        |        | xtensi | sions/ |        |        | xtensi |
|        |        |        | ons/in | indexe |        |        | ons/in |
...
|        |        |        | /typo3 | s.typo |        |        | jects/ |
|        |        |        | /templ | 3.org/ |        |        | extens |
|        |        |        | ates-i | typo3c |        |        | ion-in |
|        |        |        | ndexed | ms/ext |        |        | dexeds |
|        |        |        | -searc | ension |        |        | earch_ |
|        |        |        | h-extb | s/inde |        |        | ttnews |
|        |        |        | ase-fl | xed_se |        |        | _crawl |
|        |        |        | uid-ue | arch/I |        |        | er>`__ |
|        |        |        | bersch | ndexin |        |        |        |
|        |        |        | reiben | gConfi |        |        |        |
|        |        |        | />`__) | gurati |        |        |        |
...
|        |        |        |        | ml>`__ |        |        |        |
+--------+--------+--------+--------+--------+--------+--------+--------+
| `      | `Solr  |        | Yes    | `Sc    | Yes    | Yes    | `forge |
| Apache | s      |        |        | hedule |        |        |  <http |
| Solr   | erver  |        |        | r <htt |        |        | s://fo |
| for    | <https |        |        | ps://f |        |        | rge.ty |
| TYPO3  | ://luc |        |        | orge.t |        |        | po3.or |
| CMS <  | ene.ap |        |        | ypo3.o |        |        | g/proj |
| https: | ache.o |        |        | rg/pro |        |        | ects/e |
| //gith | rg/sol |        |        | jects/ |        |        | xtensi |
| ub.com | r/>`__ |        |        | extens |        |        | on-sol |
| /TYPO3 |        |        |        | ion-so |        |        | r>`__, |
| -Solr/ |        |        |        | lr/wik |        |        | `      |
| ext-so |        |        |        | i/Inde |        |        | TER <h |
| lr>`__ |        |        |        | xing_M |        |        | ttps:/ |
...
| https: | https: |        |        |        |        |        | ://ext |
| //gith | //luce |        |        |        |        |        | ension |
| ub.com | ne.apa |        |        |        |        |        | s.typo |
| /DMKEB | che.or |        |        |        |        |        | 3.org/ |
| USINES | g/solr |        |        |        |        |        | extens |
| SGMBH/ | />`__, |        |        |        |        |        | ion/mk |
| typo3- | `Lu    |        |        |        |        |        | search |
| mksear | cene < |        |        |        |        |        | />`__, |
| ch>`__ | https: |        |        |        |        |        | `      |
...
| rvices |        |        |        |        |        |        |        |
+--------+--------+--------+--------+--------+--------+--------+--------+
| `      | goog   |        | No     | Ex     | Yes    | No     | `forg  |
| Google | le.com |        |        | ternal |        |        | e <htt |
| Site   |        |        |        |        |        |        | ps://f |
| Sear   |        |        |        |        |        |        | orge.t |
| ch <ht |        |        |        |        |        |        | ypo3.o |
| tps:// |        |        |        |        |        |        | rg/pro |
...
|        |        |        |        |        |        |        | s/>`__ |
+--------+--------+--------+--------+--------+--------+--------+--------+
| `      | goog   | not in | No     | Ex     | Yes    | No     | `      |
| Google | le.com | TER    |        | ternal |        |        | forge  |
| Site   |        |        |        |        |        |        | <https |
| S      |        |        |        |        |        |        | ://for |
| earch  |        |        |        |        |        |        | ge.typ |
| <https |        |        |        |        |        |        | o3.org |
...
| ch>`__ |        |        |        |        |        |        |        |
+--------+--------+--------+--------+--------+--------+--------+--------+
| `Yet   | goog   |        | No     | Ex     | Yes    | No     | `forg  |
| a      | le.com |        |        | ternal |        |        | e <htt |
| nother |        |        |        |        |        |        | ps://f |
| Google |        |        |        |        |        |        | orge.t |
| sear   |        |        |        |        |        |        | ypo3.o |
| ch <ht |        |        |        |        |        |        | rg/pro |
...
-  Practical comparison of different TYPO3 search solutions `Easy Guide
   to TYPO3 Indexed Search: Series
