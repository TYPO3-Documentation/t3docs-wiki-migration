...
.. container::
   ...
   |                                   | Y AND USES Z                      |
   +-----------------------------------+-----------------------------------+
   | **documentation state**           | **[[:Category:|]] [[Category:]]** |
   |                                   | |document state list|             |
   |                                   | `licence                          |
   |                                   | OCL <http:/                       |
...
.. container::
   ...
   .. container::
      ...
      You just created a new project-page.
      You also `should create a
      forge-project <https://forge.typo3.org/start/about>`__ [not
      available anymore]
