...
extensions can hook [outdated wiki link] up into index.php and take over
the rendering of the page via the eID HTTP GET parameter. But for
backwards compatibility we should try to stick with these reserved
typeNums.
...
500 for Ajax [outdated wiki link] communication
