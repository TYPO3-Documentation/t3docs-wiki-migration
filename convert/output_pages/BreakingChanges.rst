...
.. container::
   ...
   .. container::
      ...
      TYPO3 versions 6.2 and below. The information about breaking
      changes is now maintained in the Core Changelogs. For information
...
**Hint:** Always keep an eye on your deprecation log (located at
*typo3conf/deprecation_*.log* if enabled) and upgrade your code in case
