...
-  the release notes redirect to https://get.typo3.org, e.g.
   https://get.typo3.org/release-notes/4.4
-  the Changelog entries (breaking, deprecated etc.) redirect to the
   Changelog on
   `docs.typo3.org <https://docs.typo3.org/c/typo3/cms-core/master/en-us/>`__,
   e.g.
   https://docs.typo3.org/c/typo3/cms-core/master/en-us/Changelog/7.1/Index.html
-  The core contribution related information has been merged, redirected
   to "`Contribution
...
The category can be used to mark the state of a wiki page (e.g. draft,
outdated) etc.
...
-  number of (content) pages: 767 (as calculated by
   {{NUMBEROFARTICLES}}, does not count category pages, template pages
   etc.)
