...
[outdated link]). In the case of wizards the usage of the "script" key
for type=>script wizards is deprecated. Instead the configuration option
"module" should get used
...
Kraftb [outdated wiki link] (talk [outdated wiki link]) 15:20, 7 May
2014 (CEST)
