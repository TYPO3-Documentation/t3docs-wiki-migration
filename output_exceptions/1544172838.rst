...
::
    ...
    Error handler could not fetch error page "https://project.localdomain.vm/http-error-404 [outdated link]", reason: cURL error 51: SSL: no alternative certificate subject name matches target host name 'project.localdomain.vm' (see 
