...
fileadmin/-storage (the only storage left for me). --Csehrt [outdated
wiki link] (talk [outdated wiki link]) 20:10, 12 August 2014 (CEST)
...
compressing them in a tar.gz for the move may help.-ursbraem [outdated
wiki link]
...
log in. Voilà. User:pragmas [outdated wiki link]
