...
caching-framework-tables beginning with *cf\_* helped for me [outdated
wiki link].
...
[anymore]) In my [outdated link] case, the truncating of the cf_-tables
was sufficient.
